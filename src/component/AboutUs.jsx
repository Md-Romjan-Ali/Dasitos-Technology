...
const AboutUs = () => {
    ...
    return (
        <section className="relative w-full bg-[#030712] text-white py-20 px-6 sm:px-12 lg:px-20 overflow-hidden border-b border-slate-800/80">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
                ...
                >
                    {/* Section Badge */}
                    <span className="inline-block px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs font-semibold tracking-wider uppercase">
                        About Us
                    </span>

                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white leading-tight">
                        Amaze PMS Pvt Ltd <span className="text-blue-500">(AMAZE)</span>
                    </h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                        {highlights.map((item, index) => (
                            <motion.div
                                ...
                                className="flex items-center gap-3 bg-slate-900/60 border border-slate-800 p-3.5 rounded-xl backdrop-blur-md"
                            >
                                <FiCheckCircle className="text-blue-500 text-xl flex-shrink-0" />
                    ...
                    <div className="pt-4">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="px-8 py-4 rounded-full bg-blue-600 hover:bg-blue-500 text-white font-medium text-sm transition-all shadow-lg shadow-blue-600/30 flex items-center gap-3 group"
                        >
                ...
                {/* Right Images Composition Column */}
                <div className="lg:col-span-5 relative flex justify-center items-center mt-8 lg:mt-0">

                    {/* Main Background Image Card (Action Group Shield Logo) */}
                    <motion.div
                    ...
                    {/* Overlapping Floating Team Photo Card */}
                    <motion.div
                        initial={{ opacity: 0, x: -40, y: 30 }}
                        whileInView={{ opacity: 1, x: 0, y: 0 }}
                        viewport={{ once: true }}
                        transition={{ duration: 0.8, delay: 0.3 }}
                        className="absolute -bottom-6 -left-2 sm:-left-8 w-[280px] sm:w-[320px] rounded-2xl overflow-hidden border-2 border-slate-800 bg-slate-900 shadow-2xl p-2 bg-slate-900/90 backdrop-blur-xl"
                    >
