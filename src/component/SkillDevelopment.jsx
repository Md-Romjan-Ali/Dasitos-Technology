...
import { FiAward, FiCheckCircle, FiCpu, FiHome, FiMapPin, FiShield, FiUserCheck } from "react-icons/fi";
...
const SkillDevelopmentSection = () => {
    ...
    return (
        <section className="relative bg-[#030712] text-white py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className="absolute bottom-1/4 -left-40 w-96 h-96 bg-indigo-600/10 rounded-full blur-3xl pointer-events-none" />
                    ...
                    {highlights.map((item, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                whileHover={{ y: -6 }}
                                className="p-6 rounded-3xl border border-slate-800 bg-slate-900/40 backdrop-blur-xl hover:border-blue-500/40 transition-all duration-300 flex items-start gap-4"
                            >
                ...
                <div className="space-y-8">
                    ...
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className="rounded-3xl border border-slate-800 bg-slate-900/30 p-8 sm:p-10 backdrop-blur-xl shadow-2xl space-y-8"
                        >
                            {/* Panel Header */}
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-6">
                                ...
                                <div className="text-xs font-medium text-slate-400 bg-slate-800/60 px-4 py-2 rounded-xl border border-slate-700/50 self-start sm:self-auto">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                                {currentDomain.items.map((module, idx) => (
                                    <motion.div
                                        ...
                                        className="flex items-center gap-3 p-4 rounded-2xl border border-slate-800/80 bg-slate-900/50 hover:border-blue-500/30 hover:bg-slate-800/40 transition-all group"
                                    >
                                        <FiCheckCircle className="text-blue-400 shrink-0 size-5 group-hover:scale-110 transition-transform" />
