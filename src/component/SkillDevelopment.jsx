...
const SkillDevelopmentSection = () => {
    ...
    return (
        <section className="relative bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 py-24 px-4 sm:px-6 lg:px-8 overflow-hidden transition-colors duration-300">
            {/* Dynamic Ambient Background Accents */}
            <div className="absolute top-1/4 -right-40 w-96 h-96 bg-blue-500/10 dark:bg-blue-600/15 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute bottom-1/4 -left-40 w-96 h-96 bg-indigo-500/10 dark:bg-indigo-600/15 rounded-full blur-3xl pointer-events-none" />

            <div className="max-w-7xl mx-auto space-y-16 relative z-10">
                {/* HEADER */}
                <div className="text-center max-w-3xl mx-auto space-y-4">
                    <span className="text-blue-600 dark:text-blue-400 text-xs sm:text-sm font-semibold tracking-wider uppercase bg-blue-50 dark:bg-blue-500/10 px-3.5 py-1.5 rounded-full border border-blue-200 dark:border-blue-500/20 inline-block">
                        Workforce Readiness
                    </span>
                    ...
                    {highlights.map((item, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                whileHover={{ y: -6 }}
                                className="p-6 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 backdrop-blur-xl hover:border-blue-500/40 dark:hover:border-blue-500/40 transition-all duration-300 flex items-start gap-4 shadow-sm dark:shadow-none"
                            >
                ...
                <div className="space-y-8">
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center gap-2.5 px-6 py-3 rounded-2xl text-sm font-semibold transition-all duration-300 border ${isActive
                                        ...
                                        : "bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 hover:text-slate-900 dark:hover:text-white shadow-sm dark:shadow-none"
                                        }`}
                                >
                    ...
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/80 p-8 sm:p-10 backdrop-blur-xl shadow-xl dark:shadow-2xl space-y-8"
                        >
                            {/* Panel Header */}
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-6">
                                <div>
                                    <span className="text-blue-600 dark:text-blue-400 text-xs font-semibold uppercase tracking-wider bg-blue-50 dark:bg-blue-500/10 px-3 py-1 rounded-full border border-blue-200 dark:border-blue-500/20 inline-block">
                                        {currentDomain.tag}
                                    </span>
                                ...
                                <div className="text-xs font-medium text-slate-600 dark:text-slate-400 bg-slate-100 dark:bg-slate-800/80 px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700/60 self-start sm:self-auto">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {currentDomain.items.map((module, idx) => (
                                    <motion.div
                                        ...
                                        className="flex items-center gap-3 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 hover:border-blue-500/30 dark:hover:border-blue-500/30 hover:bg-white dark:hover:bg-slate-800/50 transition-all group shadow-sm dark:shadow-none"
                                    >
